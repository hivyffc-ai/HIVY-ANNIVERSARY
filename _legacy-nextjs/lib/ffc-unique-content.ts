...
**Creating New Memories**: While cherishing the past, your ${kw.toLowerCase()} is also about creating new beautiful memories together. Our intimate setting under the ${spouse.toLowerCase() === 'wife' ? 'starlit sky' : 'city lights'} provides the perfect backdrop for new chapters.
...
**Venue Magic**: Our elegant venue offers breathtaking panoramic views of ${city}. As the sun sets and city lights come alive, your celebration transforms into a magical experience that's hard to find elsewhere.
...
**Venue & Duration**: Full 3 hours of exclusive access to your chosen setup – glass house. The space is entirely yours from your arrival until you leave.
...
**private venue with City View**: Our venue provides a spectacular backdrop of ${city}'s skyline. Golden hour shots here are simply magical for any ${kw.toLowerCase()}.
...
**Stunning private venue & Glass House**: Choose between our breathtaking private venue with panoramic city views or our elegant glass house for an intimate ${kwLower} experience. Both options are equally magical!
...
**Repeat Customers**: Many couples return for multiple celebrations – anniversaries, birthdays, special dates. That's the highest endorsement for our ${kwLower} services.`
  ...
  if (slug.includes('birthday')) {
    testimonialContent = `"My husband's ${kwLower} at ${venue} was beyond amazing! The romantic setup exceeded all expectations. He was genuinely surprised!" – Priya M., ${city}
...
"Best ${kwLower} venue in ${city}! The team was so helpful with surprise coordination." – Sneha & Amit, Gotri`;
    ...
    testimonialContent = `"Our 5th anniversary ${kwLower} was magical! The candlelight setup on the private venue was so romantic." – Kavita & Raj, ${city}
...
"Best ${kwLower} experience in ${city}! Will definitely come back for our anniversary." – Riya & Arjun, Gotri`;
  ...
  const faqContent = [
    ...
    },
    {
      ...
      answer: `Yes, 100% private! No other guests will be present during your 3-hour ${kwLower} slot. The entire space – glass house – is exclusively yours.`
    },
    {
...
**Multiple Options**: Whether you prefer an open private venue or cozy glass house, we offer options that suit different preferences of ${areaName} couples.`
    },
    {
