...
const keyword = service.keywords.find(k => k.slug === "anniversary-restaurants-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "anniversary restaurants", "romantic restaurants", "Surat", "HIVY"],
