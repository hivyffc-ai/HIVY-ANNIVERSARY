...
const keyword = getAnniversaryKeywordBySlug("50th-golden-anniversary-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "50th anniversary", "golden anniversary", "golden jubilee", "Surat", "HIVY Anniversary"],
