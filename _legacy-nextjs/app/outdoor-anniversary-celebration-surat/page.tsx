...
const keyword = getAnniversaryKeywordBySlug("outdoor-anniversary-celebration-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "outdoor celebration", "garden anniversary", "al fresco dining", "Surat", "HIVY Anniversary"],
