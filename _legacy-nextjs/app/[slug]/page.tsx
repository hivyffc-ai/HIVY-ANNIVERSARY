...
export async function generateMetadata({
  ...
  if (area) {
    ...
    const areaDescription = `Book romantic celebrations, candlelight dinners, birthday surprises & anniversary parties in ${area.name}, Surat at HIVY - Place for Celebrations. Private elegant venue with stunning setups. Call +91 74878 88730.`;
