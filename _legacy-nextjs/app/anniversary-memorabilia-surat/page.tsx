...
const keyword = service.keywords.find(k => k.slug === "anniversary-memorabilia-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "custom gifts", "keepsakes", "couple celebration", "Surat", "HIVY Anniversary"],
