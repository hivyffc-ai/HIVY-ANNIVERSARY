...
const keyword = getAnniversaryKeywordBySlug("budget-anniversary-celebration-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "budget anniversary", "affordable celebration", "pocket-friendly", "Surat", "HIVY Anniversary"],
