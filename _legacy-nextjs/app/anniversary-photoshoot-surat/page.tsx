...
const keyword = getAnniversaryKeywordBySlug("anniversary-photoshoot-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "anniversary photos", "couple photography", "romantic photoshoot", "Surat", "HIVY Anniversary"],
