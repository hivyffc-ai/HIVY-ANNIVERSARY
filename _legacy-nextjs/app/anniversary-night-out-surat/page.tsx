...
const keyword = getAnniversaryKeywordBySlug("anniversary-night-out-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "anniversary night", "romantic evening", "date night anniversary", "Surat", "HIVY Anniversary"],
