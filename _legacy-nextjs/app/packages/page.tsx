...
export const metadata: Metadata = {
  ...
  description: 'Explore 5 unique romantic celebration packages at HIVY - Place for Celebrations Surat. From romantic setups to bohemian experiences. Starting from ₹5,100.',
