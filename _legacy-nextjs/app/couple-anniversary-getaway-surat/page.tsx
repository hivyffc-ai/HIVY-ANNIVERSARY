...
const keyword = getAnniversaryKeywordBySlug("couple-anniversary-getaway-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "anniversary getaway", "couple staycation", "romantic weekend", "Surat", "HIVY Anniversary"],
