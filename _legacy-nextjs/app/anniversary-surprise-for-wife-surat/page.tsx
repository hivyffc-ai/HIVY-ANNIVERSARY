...
const keyword = service.keywords.find(k => k.slug === "anniversary-surprise-for-wife-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "anniversary surprise", "wife anniversary", "Surat", "HIVY"],
