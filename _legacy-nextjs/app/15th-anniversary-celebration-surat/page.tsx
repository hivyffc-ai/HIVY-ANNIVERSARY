...
const keyword = getAnniversaryKeywordBySlug("15th-anniversary-celebration-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "15th anniversary", "crystal anniversary", "Surat", "HIVY Anniversary"],
