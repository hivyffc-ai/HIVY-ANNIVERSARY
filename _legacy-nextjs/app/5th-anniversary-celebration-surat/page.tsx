...
const keyword = getAnniversaryKeywordBySlug("5th-anniversary-celebration-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "5th anniversary", "wood anniversary", "fifth anniversary", "Surat", "HIVY Anniversary"],
