...
const keyword = getAnniversaryKeywordBySlug("20th-anniversary-celebration-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "20th anniversary", "china anniversary", "Surat", "HIVY Anniversary"],
