...
const keyword = service.keywords.find(k => k.slug === "anniversary-surprise-for-husband-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "anniversary surprise", "husband anniversary", "Surat", "HIVY"],
